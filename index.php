...
$page_title = 'Linguafan-Home';
$js_include_list = ['helpers.js','newsletter.js'];
$active = 'index';
...
<header>
        ...
        <button type="button" onclick="window.location.href='pages/courses.php'">Jetzt starten</button>
        </div>
</header> 
...
<main>
    ...
    <div class="flex news wrap85"> 
        ...
        <div class="newsletter" id="newsletter">
            ...
            <form action="<?= BASE_URL ?>" id="newsletter-form">
